...
const STATIC_ASSETS = [
    ...
    '/static/css/main-v2.f0771912.css',
    '/static/css/public.f8aaa6fd.css',
...
async function networkOnlyHtml(event) {
    ...
    try {
        ...
        const offlineResponse = await caches.match('/static/offline.71147918.html');
