...
const STATIC_ASSETS = [
    ...
    '/static/css/main-v2.4965ed02.css',
    '/static/css/public.62feef06.css',
...
async function networkOnlyHtml(event) {
    ...
    try {
        ...
        const offlineResponse = await caches.match('/static/offline.2f82a90f.html');
