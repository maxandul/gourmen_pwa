...
#### 8.3.4 Handoff: Paket **7f** (nächster Agent, ohne Chat-Kontext)

**Stand:** Pakete **7a–7e** sind in **§8.3.1** **erledigt**. Offen ist nur **7f** — Abschluss- und Aufräum-Paket.

**Branch:** ausschließlich **`redesign`** committen; **kein** Push auf **`master`** ohne ausdrückliche User-Vorgabe (**§15**).

**Zuerst lesen (Reihenfolge):** **§16** (Ende-Kriterium + **§16.2** Backlog) · **§13** / **§13.1** · **§8.3.1** Zeile **7f** · **`.cursor/rules/redesign.mdc`** (Pre-Flight) · dieser Abschnitt.
...
**Nächster Phase-7-Block:** Paket **7f** — **detaillierte Handoff-Checkliste** **§8.3.4** (nicht nur **§8.3.1**-Tabelle).
