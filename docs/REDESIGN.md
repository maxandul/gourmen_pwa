...
| Bewertungsliste (Detail) | `.data-table` + **`.events-ratings-others-table`**, Spalten **`__col-member`** / **`__col-score`** / **`__col-highlight`**, Text **`__highlight-text`** / **`__dash`**                                                                                                                                     | Tab **Bewertungen** auf Event-Detail: eine Zeile pro fremder Bewertung (Mitglied = Spirit + Rufname, Gesamt/Essen/Getränke/Service, Highlight); **`table-responsive data-table-wrap`**. |
...
- **Tab Bewertungen:** Card **Gesamtbewertung** mit **`clipboard-list`** + **`metrics-spotlight`** / **`metrics-spotlight__hero`** (Durchschnitt aller Bewertungen); fremde Bewertungen: **`events-ratings-others-table`** (**§5.2**).
...
| Fremde Event-Bewertungen (Tabelle)              | **`events-ratings-others-table`** (**§5.2**) — eine Zeile pro Mitglied, Spalten inkl. Highlight                                                                                  |
...
| 2026-04-05 | 4/UX | **Tab Bewertungen:** Gesamtdurchschnitt in Card **Gesamtbewertung** mit **`clipboard-list`** + **`metrics-spotlight__hero`** (wie GGL-Summary). Fremde Bewertungen: **`data-table events-ratings-others-table`** (Spalten u. a. Mitglied **`display_spirit_rufname`**, Gesamt/Essen/Getränke/Service, Highlight). | Einheitliche Hero- und Tabellenmuster |
