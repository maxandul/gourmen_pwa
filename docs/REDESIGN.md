...
| Kennzahlen-Spotlight   | `.metrics-spotlight`, `.metrics-spotlight__context`, `.metrics-spotlight__hero`, `.metrics-spotlight__metric`, `.metrics-spotlight__metric-label`, `.metrics-spotlight__metric-value`, `.metrics-spotlight__metric-value--accent`, `.metrics-spotlight__metric-hint` | **1–2 prominente Kennzahl-Paare** (große Werte, optional Hint z. B. „von N“). **GGL** Tab „Deine Performance“: Rang + Punkte; **Events** Tab Statistiken: je ein Spotlight-Block für Event- und BillBro-Kennzahlen. CSS: **`components.css`** (Abschnitt ab Kommentar „Kennzahlen-Spotlight“).                                                                                                                                                                            |
...
| 3 Events-Übersicht | erledigt | Wie zuvor; **Filter-Leiste:** nach **GET-Submit Filtern** einklappen + **`sessionStorage`** geschlossen (**§5.2.3**). Sonst unverändert: Tool-Strip, Tabs **`tabs--panel`**, Tabellen, Statistiken **`metrics-spotlight`** + **`stat-tiles--metrics-follow`**, usw. |
