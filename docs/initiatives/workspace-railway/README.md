...
| 5 | done | `phase/05-workspace-ical-feed` | 2026-05-14 | iCal pro Mitglied: `CalendarFeedService`, `/calendar/<token>.ics`, Settings in `member.technical`, Admin-Status ohne Token; Commit `5976f5f`; Spec `docs/capabilities/calendar.md` |
