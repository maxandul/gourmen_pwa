...
**Status**: aktiv  
**Start**: 2026-05  
**Branch-Prefix**: `phase/NN-public-area-<kurzname>`
...
- `/restaurants` ist mehr als nur Hitlist-Tabelle – Page-Hierarchie und Sortierung passen zur Stand-alone-Seite (Detail spaeter zu spezifizieren).
