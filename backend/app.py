...
def create_app(config_name=None):
    ...
    try:
        ...
        # Register blueprints
        from backend.routes import public, auth, dashboard, events, billbro, stats, ggl, account, member, admin, docs, notifications, ratings, migrate, test_migrate, init_db
