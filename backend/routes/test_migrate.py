...
test_migrate_bp = Blueprint('test_migrate', __name__)

@test_migrate_bp.route('/test/migrate/merch', methods=['GET'])
def test_migrate_merch():
    """Test-Endpoint zum Erstellen der Merch-Tabellen (ohne Login-Requirement)"""
